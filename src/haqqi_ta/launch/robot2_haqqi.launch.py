#!/usr/bin/env python3
"""
robot2_haqqi.launch.py — haqqi_ta
Dijalankan DI robot2 fisik.

Urutan startup di robot2:
  Terminal 1: ros2 launch yahboomcar_multi yahboomcar_bringup_multi.launch.xml robot_name:=robot2
  Terminal 2: ros2 launch yahboomcar_multi ms200_scan_robot2.launch.py
  Terminal 3: ros2 launch haqqi_ta robot2_haqqi.launch.py

Wiring cmd_vel:
  modified_dwa_node → /robot2/cmd_vel_raw → [fault_injector] → /robot2/cmd_vel → driver motor
