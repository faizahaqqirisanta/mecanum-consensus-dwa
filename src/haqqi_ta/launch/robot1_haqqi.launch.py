#!/usr/bin/env python3
"""
robot1_haqqi.launch.py — haqqi_ta
Dijalankan DI robot1 fisik.

Urutan startup di robot1:
  Terminal 1: ros2 launch yahboomcar_multi yahboomcar_bringup_multi.launch.xml robot_name:=robot1
  Terminal 2: ros2 launch yahboomcar_multi ms200_scan_robot1.launch.py
  Terminal 3: ros2 launch haqqi_ta robot1_haqqi.launch.py

Wiring cmd_vel:
  modified_dwa_node → /robot1/cmd_vel_raw → [fault_injector] → /robot1/cmd_vel → driver motor
